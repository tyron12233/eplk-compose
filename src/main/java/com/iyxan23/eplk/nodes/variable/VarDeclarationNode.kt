...
class VarDeclarationNode(
    ...
    override fun visit(scope: Scope): RealtimeResult<EplkObject> {
        ...
        if (scope.symbolTable.symbols.containsKey(variableName)) {
        ...
        if (variableValue != null) {
            ...
            scope.symbolTable.symbols[variableName] = visitValue as EplkObject

            return result.success(visitValue)
        } else {
            scope.symbolTable.symbols[variableName] = EplkVoid(scope)
